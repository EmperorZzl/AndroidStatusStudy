package com.devstrongzhao.study.utils;
...
public class StatusBarUtils {
    ...
    public void init() {
//        myFullScreen(mActivity, Color.TRANSPARENT);
...
//                attributes.flags |= flagTranslucentNavigation;
     ...
     */
    public static void myFullScreen(Activity activity, int color) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {//android5.0以上设置透明效果
                ...
                win.setNavigationBarColor(Color.TRANSPARENT);//导航栏颜色也可以正常设置
